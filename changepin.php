	...
	<!-- Main menu (tabs) -->
     <div id="tabs" class="">
           ...
           <ul class="box">
                ...
                <li id="active"><a href="changepin.php">Change PIN<span class="tab-l"></span><span class="tab-r"></span></a></li>
...
<strong><h4>Change Your PIN ...</h4></strong>
<form action="changepinac.php" method="post"><table>
<tr>
		<td>Enter old PIN :</td>
		<td><input type="password" name="oldpin"></td>
</tr>
<tr>
		<td>Enter New PIN :</td>
		<td><input type="password" name="newpin"></td>
</tr>
<tr>
		<td>Re-Enter New PIN :</td>
		<td><input type="password" name="renewpin"></td>
</tr>
<tr>
		<td/>
