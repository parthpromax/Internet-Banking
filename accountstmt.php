...
?>
     ...
     <div id="tabs" class="">
           ...
           <ul class="box">
                ...
                <li id="active"><a href="accountstmt.php">Account Statement<span class="tab-l"></span><span class="tab-r"></span></a></li> <!-- Active -->
...
{
echo "<br><h4><span>&nbsp&nbsp&bull;&nbsp&nbspAccount Statement of Account No : ".$accno."</span></h4>";
echo "<table>
	<tr>
...
echo "<tr>
		...
		<td>".$row1['Time']."</td>
		<td/>";
if($row1['Change']=='Debit')
echo "<td>".$row1['Amount']."</td><td/>";
else
echo "<td/><td>".$row1['Amount']."</td>";
echo "</tr>";
