...
?>
	...
	<!-- Main menu (tabs) -->
     <div id="tabs" class="">
           ...
           <ul class="box">
                <li id="active"><a href="withdrawal.php">Withdrawal Money<span class="tab-l"></span><span class="tab-r"></span></a></li>
...
<strong><h4>Withdrawal Money ...</h4></strong>
<form action="change.php" method="post"><table>
<tr>
		<td>Enter Amount :</td>
		<td><input type="numeric" name="amount"></td>
</tr>
<tr>
		<td/>
